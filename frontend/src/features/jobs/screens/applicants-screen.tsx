...
import { CategoryAvatar, EmptyState, Icon, PrimaryButton, RatingStars } from "@/src/components/ui";
import { useToast } from "@/src/components/toast";
import { useAuth } from "@/src/features/auth/auth-context";
import { fetchApplicants, postSwipe } from "@/src/features/matching/services/matching-service";
    ...
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]} testID="applicants-screen">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          message="Pasang lowongan dan tunggu pekerja tertarik pada pekerjaanmu."
        />
      ) : (
        <FlatList
          data={applicants}
                ...
                <View style={{ flex: 1 }}>
                  ...
                  {item.is_new ? (
                    <View style={styles.newHintRow}>
                      <Icon name="account-plus-outline" size={14} color={colors.brandPrimary} />
...
const useStyles = makeStyles((colors) => ({
  ...
  title: { fontFamily: fonts.bold, fontSize: 24, color: colors.brandPrimary },
  ...
  newHintRow: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 2 },
  newHint: { fontFamily: fonts.medium, fontSize: 12, color: colors.brandPrimary },
